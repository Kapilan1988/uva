...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>resources/css/lib/jquery-ui.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>resources/css/lib/magnific-popup.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>resources/css/lib/settings.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>resources/css/lib/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>resources/css/lib/headern.css">
